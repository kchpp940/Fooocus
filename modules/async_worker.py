...
class AsyncTask:
    ...
    def cleanup(self, pid=None, processing_start_time=None):
        ...
        if pid is not None and pid in modules_patch.patch_settings:
            del modules_patch.patch_settings[pid]
...
def worker():
    ...
    def handler(async_task: AsyncTask):
        ...
        try:
            ...
            async_task.cleanup(pid=pid, processing_start_time=processing_start_time)
